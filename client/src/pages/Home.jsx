    ...
    <div>
        <div className="h-[650px] bg-cover bg-bottom  " style={{backgroundImage:`url(${image2})`}} >
            <div className="h-full bg-black/60 flex   ">
                ...
                <p className="text-white text-5xl">Lets guide you in buying the ideal property of your dreams</p>
                </div>
       ...
       <div className="bg-blue-900/70 text-white pb-8">
        <p className="text-center text-3xl py-6">Visit Our News Section</p>
        ...
        <div className="flex justify-center">
            <div className="grid grid-cols-3 w-2/3 gap-16 text-gray-800">
                    ...
                    <div className="bg-gray-300 p-2 rounded">
                        ...
                        <p className="py-2">Balancing work life and personal life is essential for a fullfilling career in Real state market </p>
                        <p>Narendra Modi </p>
        ...
        <div className=" flex justify-center p-4 mb-8">
            <div className="w-1/2 grid grid-cols-3 gap-8 ">
                <div className="bg-gray-200 p-3 rounded-lg">
                    ...
                    <p className="p-2 mb-10">Amazing platform. Highly recommended for real esate management. A Game changer</p>
